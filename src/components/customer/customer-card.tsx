  ...
  return (
    <main className="min-h-screen bg-[#F4F5F9] px-4 py-5">
      <div className="mx-auto max-w-sm space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3"><Button variant="secondary" className="bg-black text-white hover:bg-zinc-900" onClick={() => showToast("Клиент добавляет одну карту MemberFlow в Wallet и использует её во всех подключённых программах.")}><Wallet className="h-4 w-4" />Apple Wallet</Button><Button variant="secondary" onClick={() => showToast("Клиент добавляет одну карту MemberFlow в Wallet и использует её во всех подключённых программах.")}>Google Wallet</Button></div>
